...
# Finding trim time and fixing frames -----------------------------------------------------------------------------------------------------------------

print("Framerate: ", frameRate)
print("Total frames: ", count)
print("Video Duration: ", count/frameRate)

s = float(input("Enter starting time stamp(in sec): "))
e = float(input("Enter end time stamp(in sec): "))
